...
<div class="main-content page-content container-fluid">
    <div id="content">
        <div class="title">
            <h2>Pool View</h2>
        </div>
                ...
                <ul class="clearfix">
                    <li>
                        <div class="member-img">
                            <a href="">
                                <img src="<?php echo base_url('uploads/active.png');?>">
                            </a>
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Dashboard/User/Pool/'.$direct['user_id'].'/1');?>">
                                            <img src="<?php echo base_url('uploads/active.png');?>">
                                        </a>
                                    ...
                                    <ul class="clearfix">
                                        <?php
                                        foreach ($direct['l2'] as $k => $l2) {
                                            // pr($direct);
                                            ?>
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Dashboard/User/Pool/'.$l2['user_id']);?>">
                                                        <img src="<?php echo base_url('uploads/active.png');?>">
                                                    </a>
                                                    <span><?php echo $l2['user_id']; ?></span><br>  
                                                </div>
