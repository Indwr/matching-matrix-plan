...
<meta content="<?php echo title;?> brings overseas payments solutions in forex to brokers, traders and liquidity providers using cryptocurrency and one of the most secure and reliable digital currencies exchange." name="description">
...
<header id="header home" >
  <div class="top-header fixed-tab">
    <div class="container">
        <div class="row">
        <div class="col-sm-3"><a href="/" class="logo"><img src="<?php echo base_url(logo); ?>" style="width: 60%;" alt="logo"></a></div>
        <div class="col-sm-6">
          <div class="main-nav">
            <nav id="nav" class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="#">Menu</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item"><a class="jumper" href="#about-us">About </a></li>
        ...
        <div class="col-sm-3 mt-25">
	        	...
	        	<a class="sign up" href="<?php echo base_url('Dashboard/Register/'); ?>">Sign up</a>
      ...
      <div class="row">
        <div class="col-sm-8">
          <div class="slider-text">
            ...
            <p>With <?php echo title;?> trading platform, Start trading in FOREX with cryptocurrency and enjoy the quickest international transactions with minimum transaction fee.</p>
            <a class="slider-botton paper" href="<?php echo base_url('SiteAssets/'); ?>assets/site/images/<?php echo title;?>-whitepaper.pdf" target="_blank">White Paper</a> <a class="slider-botton paper" href="#">Presentation</a> <a class="slider-botton video" href="#">Watch Video<i><img src="<?php echo base_url('SiteAssets/'); ?>assets/site/images/video-icon.png" alt="video-icon"></i></a> </div>
        </div>
       <!--  <div class="col-sm-4">
          <div class="sale-time-box">
            <h2><?php //echo title;?>.in <span>IEO Pre Launch</span> Starts in:</h2>
            <section>
              <div id="countdown">
                <div class="cd-box">
